      ...
      <Modal
        ...
        <View style={styles.modal_container}>
          ...
          <TouchableOpacity  activeOpacity={0.8} onPress={()=>{props.oncross()}}  >
           ...
           <Text style={styles.logoutText}>If you leave, you will no longer be the host, and the next person who joined after you will become the new host. Are you sure you want to continue?</Text>
