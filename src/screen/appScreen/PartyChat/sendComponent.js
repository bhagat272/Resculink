...
const SendComponent = (item, props) => {
  ...
  // console.log("item is --ssssssssss-ssss-->",item);
  //   const playAudio = async (item) => {
  //     console.log("playAudio1---->");
  // setPlaying(!playing)

  //     audioRecorderPlayer.addPlayBackListener(item => {
  //       // setCurrentTime(Math.floor(e.currentPosition / 1000));
  //       if (e.currentPosition === item.duration) {
            ...
            <TouchableOpacity
              ...
              <MapView
                ...
                <Marker
                  ...
                  // description="This is a static marker for San Francisco."
                />
              </MapView>
            </TouchableOpacity>
          </View>
