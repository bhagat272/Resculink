...
import {createProfileApi} from '../../../appRedux/actions/userSessionAction';
...
const CreateProfile = props => {
  ...
  const createProfile = async () => {
    ...
    // newFormData.append("type", dic?.user_type);
    // newFormData.append("url", dic?.url);
    // newFormData.append(
    //   'location',
    ...
    // return
    dispatch(createProfileApi(newFormData, props?.navigation));
    // }
  };
    ...
    <View style={{flex: 1, backgroundColor: 'white'}}>
      <SafeAreaView style={styles.container}>
        {/* <Text style={{ fontSize: fonts.SIZE_20,
              ...
              color:  "#111B34",alignSelf:'center',marginTop:Platform.OS=="ios"?40:80,}}>Create Profile</Text> */}
        <KeyboardScroll>
          ...
          <CustomDropdown
            ...
            data={genderOptions}
            venue={translateText('select_gender')}
